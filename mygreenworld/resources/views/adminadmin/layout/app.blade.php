...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- Title -->
		<title>GREEN WORLD - Apanel</title>
			...
			<div class="page-main  h-100">
				...
				<aside class="app-sidebar doc-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
								<i class="side-menu__icon fa fa-align-justify"></i>
								<span class="side-menu__label"> კატეგორიები</span>
								<i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li>
									<a href="{{Request::root()}}/adminadmin/categories" class="slide-item">პროდუქციის კატეგორიები</a>
								</li>
								<li>
									<a href="{{Request::root()}}/adminadmin/category_add" class="slide-item">ახალი კატეგორიის დამატება</a>
								</li>
							</ul>
                        </li>
                        ...
                        <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
								...
								<span class="side-menu__label"> პროდუქცია</span>
								<i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
                                <li>
									<a href="{{Request::root()}}/adminadmin/products_all" class="slide-item">დამატებული პროდუქციები</a>
								</li>
								<li>
									<a href="{{Request::root()}}/adminadmin/product_add" class="slide-item">ახალი პროდუქციის დამატება</a>
								</li>
							</ul>
                        </li>
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-window-restore"></i>
								<span class="side-menu__label">გალერია</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li>
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-wikipedia-w"></i>
								<span class="side-menu__label">სიახლეები</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
                                <li>
				...
				<div class="container">
					<div class="row align-items-center flex-row-reverse">
						<div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center">
							ლევან ბედინაშვილი 598 90 64 84. <a href="https://itweb.ge">ITWEB.GE</a> საავტორო უფლებები დაცულია.
						</div>
					</div>
				</div>
			</footer>
