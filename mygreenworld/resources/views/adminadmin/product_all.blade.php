    ...
    <div class="side-app">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">დამატებული პროდუქტები</li>
            </ol>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">პროდუქტები</div>
                            ...
                            <table id="example" class="table table-striped table-bordered" >
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-15p">პროდუქტის დასახელება</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($info as $task_item)
                                        ...
                                        <td>{{ $task_item->category->name_geo  }}</td>
