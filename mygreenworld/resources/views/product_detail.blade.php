                ...
                <div class="blog-post-list wow fadeInLeft" data-wow-delay="0.3s">
                    ...
                    <div class="blog_wrp">
                        <a class="blog_img" href="javascript:void(0)">
                            <img class="img-responsive" src="{{ asset('mygreenworld/storage/app/public/'. $mainproduct->image) }}" alt="">
                        </a>
                        <div class="blog_info">
                            @if(app()->getLocale() == 'ka')
                            <a href="javascript:void(0)">
                                <h4>{{ $mainproduct->products_title_geo }}</h4>
                            </a>
                            @endif
                            @if(app()->getLocale() == 'en')
                            <a href="javascript:void(0)">
                                <h4>{{ $mainproduct->products_title_eng }}</h4>
                            </a>
                            @endif
                            @if(app()->getLocale() == 'ru')
                            <a href="javascript:void(0)">
                                <h4>{{ $mainproduct->products_title_rus }}</h4>
                            </a>
                            @endif
                            ...
                            @if(app()->getLocale() == 'en')
                            <a href="javascript:void(0)">
                                <p>{!! $mainproduct->products_text_eng !!}</p>
                            </a>
                            @endif
                            @if(app()->getLocale() == 'ru')
                            <a href="javascript:void(0)">
                                <p>{!! $mainproduct->products_text_rus !!}</p>
                            </a>
                            @endif
